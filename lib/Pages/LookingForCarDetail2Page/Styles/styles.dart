...
class LookingForCarDetail2PageStyles {
  ...
  LookingForCarDetail2PageStyles(BuildContext context) {}
}

class LookingForCarDetail2PageMobileStyles extends LookingForCarDetail2PageStyles {
  LookingForCarDetail2PageMobileStyles(BuildContext context) : super(context) {
    ScreenUtil.init(
      context,
...
class LookingForCarDetail2PageTabletStyles extends LookingForCarDetail2PageStyles {
  LookingForCarDetail2PageTabletStyles(BuildContext context) : super(context) {
...
class LookingForCarDetail2PageDesktopStyles extends LookingForCarDetail2PageStyles {
  LookingForCarDetail2PageDesktopStyles(BuildContext context) : super(context) {
    devicePixelRatio = MediaQuery.of(context).devicePixelRatio;
    deviceWidth = MediaQuery.of(context).size.width;
    deviceHeight = MediaQuery.of(context).size.height;
    statusbarHeight = MediaQuery.of(context).padding.top;
...
class LookingForCarDetail2PageLargeDesktopStyles extends LookingForCarDetail2PageStyles {
  LookingForCarDetail2PageLargeDesktopStyles(BuildContext context) : super(context) {
    ScreenUtil.init(
      context,
