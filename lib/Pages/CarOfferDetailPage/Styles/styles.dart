...
class CarOfferDetailPageStyles {
  ...
  CarOfferDetailPageStyles(BuildContext context) {}
}

class CarOfferDetailPageMobileStyles extends CarOfferDetailPageStyles {
  CarOfferDetailPageMobileStyles(BuildContext context) : super(context) {
    ScreenUtil.init(
      context,
...
class CarOfferDetailPageTabletStyles extends CarOfferDetailPageStyles {
  CarOfferDetailPageTabletStyles(BuildContext context) : super(context) {
...
class CarOfferDetailPageDesktopStyles extends CarOfferDetailPageStyles {
  CarOfferDetailPageDesktopStyles(BuildContext context) : super(context) {
    devicePixelRatio = MediaQuery.of(context).devicePixelRatio;
    deviceWidth = MediaQuery.of(context).size.width;
    deviceHeight = MediaQuery.of(context).size.height;
    statusbarHeight = MediaQuery.of(context).padding.top;
...
class CarOfferDetailPageLargeDesktopStyles extends CarOfferDetailPageStyles {
  CarOfferDetailPageLargeDesktopStyles(BuildContext context) : super(context) {
    ScreenUtil.init(
      context,
