...
class CustomProgressDialog {
  ...
  CustomProgressDialog(BuildContext context, {String message, double width, double borderRadius, Color backgroundColor, double indicatorSize}) {
    ...
    dlg.style(
      ...
      messageTextStyle: TextStyle(color: Colors.black, fontSize: 13.0),
    );
  }

  static CustomProgressDialog of({
